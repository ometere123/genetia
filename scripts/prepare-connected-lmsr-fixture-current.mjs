...
const out = `${root}/contracts/genlayer/fixtures/connected_lmsr_live_current.json`;
const outRecord = `${root}/deployments/base-connected-lmsr-current.json`;
...
console.log(JSON.stringify({ fixture: "contracts/genlayer/fixtures/connected_lmsr_live_current.json", marketId, baseMarketAddress, vaultAddress, manifestHash: manifest.manifest_hash, b: b.toString(), fundingTarget: "100000000", closeTime, resolutionAvailableTime, terminalDeadline }));
