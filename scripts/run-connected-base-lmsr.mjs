...
const recordPath = `${root}/deployments/base-connected-lmsr.json`;
const record = read("deployments/base-connected-lmsr.json");
const fixture = read("contracts/genlayer/fixtures/connected_lmsr_live.json");
const genlayer = read("deployments/genlayer-connected-lmsr.json");
